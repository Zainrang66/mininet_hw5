...
def run():
    ...
    router_A.cmd('ip route add 20.10.172.0/25 via 20.10.100.2 dev ra-eth1')
    router_A.cmd('ip route add 20.10.172.192/27 via 20.10.100.6 dev ra-eth2')
    router_B.cmd('ip route add 20.10.172.128/26 via 20.10.100.1 dev rb-eth1')
    router_B.cmd('ip route add 20.10.172.192/27 via 20.10.100.10 dev rb-eth2')
    router_C.cmd('ip route add 20.10.172.128/26 via 20.10.100.5 dev rc-eth1')
    router_C.cmd('ip route add 20.10.172.0/25 via 20.10.100.9 dev rc-eth2')

    host_A_1.cmd('ip route add 20.10.172.0/25 via 20.10.172.190')
    host_A_1.cmd('ip route add 20.10.172.192/27 via 20.10.172.190')
    host_A_2.cmd('ip route add 20.10.172.0/25 via 20.10.172.190')
    host_A_2.cmd('ip route add 20.10.172.192/27 via 20.10.172.190')
    host_B_1.cmd('ip route add 20.10.172.128/26 via 20.10.172.126')
    host_B_1.cmd('ip route add 20.10.172.192/27 via 20.10.172.126')
    host_B_2.cmd('ip route add 20.10.172.128/26 via 20.10.172.126')
    host_B_2.cmd('ip route add 20.10.172.192/27 via 20.10.172.126')
    host_C_1.cmd('ip route add 20.10.172.128/26 via 20.10.172.222')
    host_C_1.cmd('ip route add 20.10.172.0/25 via 20.10.172.222')
    host_C_2.cmd('ip route add 20.10.172.128/26 via 20.10.172.222')
    host_C_2.cmd('ip route add 20.10.172.0/25 via 20.10.172.222')
